...
10000"#;
    ...
    #[test]
    pub fn test_day_1_part1() {
        assert_eq!(part_1(include_str!("input/day_1.txt")), 72070);
    }
...
10000"#;
    ...
    #[test]
    pub fn test_day_1_part2() {
        assert_eq!(part_2(include_str!("input/day_1.txt")), 211805);
    }
}
